const visions = [
  ['CCU (greenhouse gases as raw material for greenhouse horticulture)', 100, 0, 100, 0, 0, 'Geenhouse gasses are used as raw material for enhancing horticulture. An increased CO₂ level in horticultural geenhouses will increase production.', ''],
  ...
  ['Storage CO₂ in soil, forest and nature', 40, 0, 0, 0, 100, '', ''],
  ['100000 hectares of forest built to capture CO₂', 70, 0, 0, 0, 100, 'Part of the forestal area will be realised in Overijssel which requires additional space.', 'Analysis sustainability targets rural area Overijssel 2050, 2018 (Analyse verduurzamingsopgaven landelijk gebied Overijssel richting 2050, 2018)'],
  ['Carbon Capture Storage (CCS) in empty gas fields under the North Sea', 100, 0, 0, 100, 0, 'The North-sea is an appropriate place to store CO₂', ''],
