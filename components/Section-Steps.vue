    ...
    <section class="step">
      <IntersectionObserver :step="0" :noStyling="true">
        ...
        <ol class="anchor-list">
          ...
          <li class="link clickable" @click="() => scrollTo('ssp4-wildcard')">SSP4: Dependence on centralised green-energy systems</li>
          <li class="link clickable" @click="() => scrollTo('ssp5-wildcard')">SSP5: Interconnection of international IT-infrastructure</li>
        </ol>
